...
import {Row, Col, Button, Panel, FormControl, FormGroup, Checkbox} from 'react-bootstrap';
									...
									<div>
										...
										<Row>
											<Col style={fieldProps.colLeft} md={7}>
												...
												<Col style={{paddingLeft:'0px'}} md={9}>
													<div className="eventsVal" contenteditable="true" style={fieldProps.eventsParticipantsValDiv}>
