    ...
    render() {
		...
		let panelBody = (<div>
                            <Row style={fieldProps.panelBodyTitle}>
                                ...
                                <span style={{paddingLeft:'600px'}}><Link to={this.props.location.state?this.props.location.state.referrer:'/transactionId'}> <Button className="btn btn-primary" bsSize="large" style={fieldProps.button}>Verify Another Transaction</Button> </Link> </span>
