    ...
    render() {
		...
		let panelBody = (<div>
                            <Row style={fieldProps.panelBodyTitle}>
                                ...
                                <span style={{paddingLeft:'680px'}}><Link to="/home"> <Button className="btn btn-primary" bsSize="large" style={fieldProps.button}>Verify Another Transaction</Button> </Link> </span>
                            </Row><br/>
						</div>);
        return (
